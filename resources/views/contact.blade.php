@include('include.head')
  ...
  <body>
    ...
    <section class="page-bg-image shadow-bg-layer d-flex justify-content-start align-items-center " style="background-image: url(/assets/imgs/contact/banner.webp)">
