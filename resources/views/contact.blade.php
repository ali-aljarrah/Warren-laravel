@include('include.head')
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer d-flex justify-content-start align-items-center " style="background-image: url(/assets/imgs/contact/banner.webp)">
        <div class="block-padding">
              <div class="container-fluid pb-5">
                 <div class="row pb-5">
                    <div class="col-lg-10 mx-auto text-center py-5 my-5">
                        <h1 class="white-color-1 py-4 fs-32 fw-bold d-flex justify-content-center align-items-center">
                            A New Level of Respect for Your Family
                        </h1>
                        <p class="white-color fs-16 text-center">
                            ...
                            <div class="contact-dark px-5 pt-5 pb-lg-0 pb-3">
                                <div class="ps-lg-5 mx-lg-4 mb-lg-0 mb-5">
                                    ...
                                    <div class="d-flex pt-3">
                                        <a href="https://maps.app.goo.gl/acNmamWC8mGXBSRj9" target="_blank" rel="noopener noreferrer" class="btn btn-light rounded-2 px-3 pt-2 fs-14 me-3">
                                            In Person
                                        </a>
                                        <a href="tel:+1-586-756-6351" class="btn btn-outline-light">
                                            By Phone
                                        </a>
                                    </div>
                                </div>
    ...
    <section class="py-5 contact-form-bg">
      <div class="container-fluid block-padding">
        <div class="row d-flex justify-content-center align-items-center py-5">
            ...
            <div class="col-lg-5 offset-lg-1 mb-5 mb-lg-0">
                <div class="contact-form-wrapper p-4">
                    <h5 class="fs-28 dark-color-1 fw-600 mb-4">Get in touch</h5>
