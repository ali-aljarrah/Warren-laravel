    ...
    <div class="container-fluid block-padding">
        <div class="row">
            ...
            <div class="d-flex flex-wrap">
                <a href="{{route('bone-grafting')}}" class="text-decoration-none blue-color">
                ...
                <a href="{{route('dental-implants')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Dental Implants
                        </span>
                ...
                <a href="{{route('implant-supported-bridge')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                ...
                <a href="{{route('tooth-extractions')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Tooth Extractions
                        </span>
