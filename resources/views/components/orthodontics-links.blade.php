    ...
    <div class="container-fluid block-padding">
        <div class="row">
            ...
            <div class="d-flex flex-wrap">
                <a href="{{route('invisalign')}}" class="text-decoration-none blue-color">
                ...
                <a href="{{route('metal-braces')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Metal Braces
                        </span>
                ...
                <a href="{{route('suresmile')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            SureSmile®
                        </span>
