    ...
    <div class="container-fluid block-padding">
        <div class="row">
            ...
            <div class="d-flex flex-wrap">
                ...
                <a href="{{route('dental-bridges')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Dental Bridges
                        </span>
                ...
                <a href="{{route('crowns')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Crowns
                        </span>
                ...
                <a href="{{route('dentures')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Dentures
                        </span>
                ...
                <a href="{{route('fillings')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Fillings
                        </span>
                ...
                <a href="{{route('fluoride-treatments')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Fluoride Treatments
                        </span>
                ...
                <a href="{{route('inlays-and-onlays')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Inlays & Onlays
                        </span>
                ...
                <a href="{{route('nightguards')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Nightguards
                        </span>
                ...
                <a href="{{route('dental-sealants')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Dental Sealants
                        </span>
                ...
                <a href="{{route('sports-mouthguards')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Sports Mouthguards
                        </span>
                ...
                <a href="{{route('teeth-cleanings')}}" class="text-decoration-none blue-color">
                    <div class="badge-link me-3 mb-3">
                        <span class="fs-16 fw-bold me-5 blue-color">
                            Teeth Cleanings
                        </span>
