    ...
    <div class="container-fluid block-padding">
        <div class="row border-b-2 mt-4">
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                <p class="fs-14">
                    Find out more about how to reach us,
                    how to 
                    ...
                    more varied than ever, & we do our best to adapt.
                </p>
            </div>
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                <p class="fs-14">We want you to be able to make the most out of what our dental practice has to offer every time you see us. Find the details of the offers available, including 
                    <a href="{{route('offers')}}">
                     ...
                     our special pricing on certain treatments, & more. Find out more about how we handle insurance & your other options for paying for your care. We believe affordable dental care is possible for everyone!
                </p>
            </div>
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                <p class="fs-14">Time is money, as the old saying goes, & we’ve come to realize that one of the things that makes preventive dental care more expensive than it seems is the necessity of taking time off work. We’ve eliminated this hurdle to maintaining your dental health by offering 
                   <a href="https://en.wikipedia.org/wiki/Teeth_cleaning" target="_blank" rel="noopener noreferrer">
                     ...
                     appointments on the weekend. Now patients who are students or work on weekdays don’t have to take time off for their care.
                </p>
            </div>
                ...
                <p class="fs-14">Here you’ll find some frequently
                    <a href="https://en.wikipedia.org/wiki/Patient_education" target="_blank" rel="noopener noreferrer">
                     ...
                     <a href="https://en.wikipedia.org/wiki/Dental_public_health" target="_blank" rel="noopener noreferrer">
                        ...
                        in the long-term is being an active participant in your own care. That means asking us any question that comes to mind, even the ones you think you should already know the answer to. We’re not here to judge! If there is ever anything about your dental health or the treatment we’re recommending that isn’t clear to you, please let us know so we can explain further.
                </p>
            </div>
