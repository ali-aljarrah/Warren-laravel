<nav class="main-navbar p-0">
    <div class="top-nav d-none d-lg-flex align-items-center">
      <div class="container-fluid block-padding">
        <div class="row">
            <div class="col-md-6">
                <div class="text-start position-relative" id="acc-tools-wrapper">
    ...
    <div class="container-fluid block-padding position-relative">
              ...
              <ul class="list-unstyled p-0 m-0 d-none d-md-flex align-items-center flex-row">
                ...
                <li class="nav-item me-1 me-xl-4">
                  ...
                  <div class="submenu">
                    ...
                    <a id="meet-dr-lg-link" href="{{route('meet-dr-yousif')}}">Meet Our Doctor</a>
                    <a id="smile-gallery-lg-link" href="{{route('smile-gallery')}}">Smile Gallery</a>
                    <a id="patient-testimonials-lg-link" href="{{route('patient-testimonials')}}">Patient Testimonials</a>
                  </div>
                </li>

              </ul>
            <a id="contact-link" class="nav-link md-link me-1 me-xl-4" href="{{route('contact')}}">Contact Us</a>
            <a id="blog-link" class="nav-link md-link me-1 me-xl-4" href="{{route('blog')}}">Blog</a>
            <a href="{{route('contact')}}" class="btn-main-blue">Book a visit</a>
          </div>
        </div>
     ...
     <div id="sm-menu">
          <div>
            <a id="home-link" class="main-color nav-link fs-16 fw-500 text-decoration-none mb-3 d-block" href="{{route('home')}}">Home</a>
            ...
            <a id="sm-contact-link" class="main-color nav-link fs-16 fw-500 text-decoration-none mb-3 d-block" href="{{route('contact')}}">Contact</a>
            <a id="sm-blog-link" class="main-color nav-link fs-16 fw-500 text-decoration-none mb-3 d-block" href="{{route('blog')}}">Blog</a>
          </div>
            <a href="{{route('contact')}}" class="btn-menu">Book a visit</a>
          </div>
        </div>
      </div>
    </div>
