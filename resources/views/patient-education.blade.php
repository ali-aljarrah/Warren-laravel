          ...
          <div class="row">
            ...
            <div class="col-lg-5 offset-lg-1">
              ...
              <div class="d-flex flex-wrap">
                    ...
                    <a href="{{route('dental-impressions')}}" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Digital Impressions
                            </span>
                    ...
                    <a href="{{route('intraoral-camera')}}" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Intraoral Camera
                            </span>
                    ...
                    <a href="{{route('laser-dentistry')}}" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Laser Dentistry
                            </span>
                    ...
                    <a href="{{route('local-anesthesia')}}" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Local Anesthesia
                            </span>
                    ...
                    <a href="{{route('oral-cancer-screening')}}" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                    ...
                    <a href="{{route('soft-tissue-laser-dentistry')}}" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
