@include('include.head')
    ...
    <link rel="canonical" href="https://www.warrenlaserdentistry.com/patient-information/patient-education">
            ...
            <div class="row p-3 p-lg-5 d-flex justify-content-center">
              <div class="col-lg-5 mt-5 mt-lg-0">
                ...
                <div class="col-lg-5 offest-2">
                  <img width="480" height="480" class="img-fluid" loading="lazy" src="/assets/imgs/patient-information/Rectangle-tooth.webp" alt="Warren - atient Information - Warren, MI">
                </div>
            </div>
