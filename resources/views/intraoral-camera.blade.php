@include('include.head')
    ...
    <link rel="canonical" href="{{env('APP_URL')}}patient-information/patient-education/intraoral-camera">
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer " style="background-image: url(/assets/imgs/intraoral-camera/banner.webp);">
