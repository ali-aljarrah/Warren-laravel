@include('include.head')
  ...
  <body class="pt-0">
    ...
    <section class="page-bg-image" style="background-image: url(/assets/imgs/digital-panoramic-x-rays/banner.webp)">
        <div class="container-fluid block-padding pt-5">
            <div class="row">
                <div class="col-lg-9 mx-auto text-center">
                    <div class="mx-auto">
                        <a href="/patient-information/patient-education" class="text-decoration-none bg-green-card rounded-3 p-2 d-flex justify-content-center align-items-center w-fit mx-auto">
                            <span class="me-2">
    ...
    <section class="py-5">
        <div class="container-fluid block-padding">
            ...
            <div class="bg-child-blue px-4 py-5 rounded-4 mb-5">
                <h2 class="h5 fw-bold soft-dark fs-24 mb-4">What Are X-Rays?</h2>
    ...
    <section class="py-5 bg-child-blue">
        <div class="container-fluid block-padding">
            <div class="row">
                <h3 class="dark-color-1 fs-20 fw-600 mb-5">
                More Patient Education
                </h3>
                <div class="d-flex flex-wrap">
                    <a href="/patient-information/patient-education/digital-panoramic-x-rays" class="text-decoration-none blue-color">
                    ...
                    <a href="/patient-information/patient-education/dental-impressions" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Digital Impressions
                            </span>
                    ...
                    <a href="/patient-information/patient-education/intraoral-camera" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Intraoral Camera
                            </span>
                    ...
                    <a href="/patient-information/patient-education/laser-dentistry" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Laser Dentistry
                            </span>
                    ...
                    <a href="/patient-information/patient-education/local-anesthesia" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                                Local Anesthesia
                            </span>
                    ...
                    <a href="/patient-information/patient-education/oral-cancer-screening" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
                    ...
                    <a href="/patient-information/patient-education/soft-tissue-laser-dentistry" class="text-decoration-none blue-color">
                        <div class="badge-link me-3 mb-3">
                            <span class="fs-16 fw-bold me-5 blue-color">
