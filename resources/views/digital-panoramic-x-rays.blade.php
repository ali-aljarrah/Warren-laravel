@include('include.head')
    ...
    <link rel="canonical" href="https://www.URL.COM/digital-panoramic-x-rays">
        ...
        <div class="container-fluid block-padding pt-5">
            <div class="row">
                <div class="col-lg-9 mx-auto text-center">
                    <div class="mx-auto">
                        <a href="/patient-education" class="text-decoration-none bg-green-card rounded-3 p-2 d-flex justify-content-center align-items-center w-fit mx-auto">
                            <span class="me-2">
    ...
    <div class="container-fluid block-padding">
        <div class="row">
            ...
            <div class="d-flex flex-wrap">
                <a href="/digital-panoramic-x-rays" class="text-decoration-none blue-color">
