@include('include.head')
    ...
    <link rel="canonical" href="{{env('APP_URL')}}dental-services/oral-surgery/dental-implants">
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer " style="background-image: url(/assets/imgs/dental-implants/banner.webp)">
