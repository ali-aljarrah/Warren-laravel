@include('include.head')
    ...
    <link rel="canonical" href="{{env('APP_URL')}}patient-information/patient-education/dental-impressions">
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer " style="background-image: url(/assets/imgs/digital-impressions/banner.webp);">
