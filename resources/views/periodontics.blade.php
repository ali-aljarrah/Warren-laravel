            ...
            <div class="row">
                <div class="col-lg-12 bg-gray-2 py-4 px-4 rounded-4">
                      <p class="black-color fs-16">
                        Called <a href="https://en.wikipedia.org/wiki/Gingivitis" target="_blank" rel="noopener noreferrer">gingivitis</a> in its early stages, periodontal disease is caused by excessive toxic bacteria (found in plaque) that attack your mouth’s soft tissues. Early warning signs of this disease include red, swollen or bleeding gums. If caught early, we can help you reverse the damage. If detected late, we can use one of the many effective restorative dentistry procedures to restore your mouth to its healthy & beautiful state.
                      </p>
                      <p class="black-color fs-16">
                          General dentists are trained to detect periodontal disease & treat it in early stages. However, they often refer complicated or later-stage cases to a specialist. Periodontists undergo an additional three years of training in periodontics, specializing in <a href="https://en.wikipedia.org/wiki/Periodontal_disease" target="_blank" rel="noopener noreferrer">gum disease</a>, oral inflammation & dental implants. Because of their expertise in the soft tissues of the mouth, they are also often experts in soft-tissue cosmetic procedures, such as crown lengthening or gum lifts.
                      </p>
                      <p class="black-color fs-16">
