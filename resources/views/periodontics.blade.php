@include('include.head')
    ...
    <link rel="canonical" href="https://www.warrenlaserdentistry.com/dental-services/periodontics">
  ...
  <body>
    ...
    <section class="page-bg-image shadow-bg-layer " style="background-image: url(/assets/imgs/periodontics/banner.webp)">
