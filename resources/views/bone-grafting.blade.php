@include('include.head')
    ...
    <link rel="canonical" href="{{env('APP_URL')}}dental-services/oral-surgery/bone-grafting">
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer " style="background-image: url(/assets/imgs/bone-grafting/banner.webp)">
