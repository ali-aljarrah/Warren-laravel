@include('include.head')
  ...
  <body>
    ...
    <section class="py-5">
      <div class="container-fluid block-padding">
        <h5 class="dark-color-2 fs-28 fw-bold mb-5">The best in benefits</h5>
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0 flex-grow-1">
            <div class="d-flex flex-column h-100">
                <div class="mb-3">
                    <img loading="lazy" class="img-fluid" width="355" height="262" src="{{asset('/assets/imgs/home/img-14.webp')}}" alt="Warren - Braces can give you a perfect smile!">
                </div>
                <div class="pe-0 pe-lg-5">
                    <div class="fs-24 fw-600 blue-color mb-3">Braces can give you a perfect smile!</div>
                    <div class="fs-18 blue-color mb-3">
                      We are proud to offer a range of orthodontics options for our patients. • Invisalign • Traditional Braces
                    </div>
                </div>
                <div class="mt-auto">
                  <a class="btn-cyan" href="{{route('orthodontics')}}">
                    <span class="me-1">Orthodontist</span>
                    <span>
                      <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 9.58887C11.7347 9.58887 11.4804 9.48351 11.2929 9.29597C11.1053 9.10844 11 8.85408 11 8.58887C11 8.32365 11.1053 8.0693 11.2929 7.88176C11.4804 7.69422 11.7347 7.58887 12 7.58887H24C24.2652 7.58887 24.5195 7.69422 24.7071 7.88176C24.8946 8.0693 25 8.32365 25 8.58887V20.5889C25 20.8541 24.8946 21.1084 24.7071 21.296C24.5195 21.4835 24.2652 21.5889 24 21.5889C23.7347 21.5889 23.4804 21.4835 23.2929 21.296C23.1053 21.1084 23 20.8541 23 20.5889V11.0022L8.70662 25.2955C8.51706 25.4722 8.26633 25.5683 8.00726 25.5638C7.74819 25.5592 7.50101 25.4542 7.3178 25.271C7.13458 25.0878 7.02963 24.8406 7.02506 24.5816C7.02049 24.3225 7.11665 24.0718 7.29329 23.8822L21.5866 9.58887H12Z" fill="#121212"/>
                      </svg>
                    </span>
                  </a>
                </div>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 flex-grow-1">
            <div class="d-flex flex-column h-100">
                <div class="mb-3">
                    <img loading="lazy" class="img-fluid" width="355" height="262" src="{{asset('/assets/imgs/home/img-15.webp')}}" alt="Warren - I'm wearing braces!">
                </div>
                <div class="pe-0 pe-lg-5">
                    <div class="fs-24 fw-600 blue-color mb-3">"I'm wearing braces!"</div>
                    <div class="fs-18 blue-color mb-3">
                ...
                <div class="mt-auto">
                  <a class="btn-cyan" href="{{route('invisalign')}}">
                    <span class="me-1">Invisalign®</span>
                    <span>
                      <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 9.58887C11.7347 9.58887 11.4804 9.48351 11.2929 9.29597C11.1053 9.10844 11 8.85408 11 8.58887C11 8.32365 11.1053 8.0693 11.2929 7.88176C11.4804 7.69422 11.7347 7.58887 12 7.58887H24C24.2652 7.58887 24.5195 7.69422 24.7071 7.88176C24.8946 8.0693 25 8.32365 25 8.58887V20.5889C25 20.8541 24.8946 21.1084 24.7071 21.296C24.5195 21.4835 24.2652 21.5889 24 21.5889C23.7347 21.5889 23.4804 21.4835 23.2929 21.296C23.1053 21.1084 23 20.8541 23 20.5889V11.0022L8.70662 25.2955C8.51706 25.4722 8.26633 25.5683 8.00726 25.5638C7.74819 25.5592 7.50101 25.4542 7.3178 25.271C7.13458 25.0878 7.02963 24.8406 7.02506 24.5816C7.02049 24.3225 7.11665 24.0718 7.29329 23.8822L21.5866 9.58887H12Z" fill="#121212"/>
                      </svg>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 flex-grow-1">
            <div class="d-flex flex-column h-100">
                <div class="mb-3">
                    <img loading="lazy" class="img-fluid" width="355" height="262" src="{{asset('/assets/imgs/home/img-16.webp')}}" alt="Warren - More comfortable dentistry has arrived!">
                </div>
                <div class="pe-0 pe-lg-5">
                    <div class="fs-24 fw-600 blue-color mb-3">More comfortable dentistry has arrived!</div>
                    <div class="fs-18 blue-color mb-3">
                      We use the latest in laser technology: No Drills or Needles. Virtually Painless. Anesthesia Rarely Needed.
                    </div>
                </div>
                <div class="mt-auto">
                  <a class="btn-cyan" href="{{route('soft-tissue-laser-dentistry')}}">
                    <span class="me-1">Soft Tissue Laser</span>
                    <span>
                      <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 9.58887C11.7347 9.58887 11.4804 9.48351 11.2929 9.29597C11.1053 9.10844 11 8.85408 11 8.58887C11 8.32365 11.1053 8.0693 11.2929 7.88176C11.4804 7.69422 11.7347 7.58887 12 7.58887H24C24.2652 7.58887 24.5195 7.69422 24.7071 7.88176C24.8946 8.0693 25 8.32365 25 8.58887V20.5889C25 20.8541 24.8946 21.1084 24.7071 21.296C24.5195 21.4835 24.2652 21.5889 24 21.5889C23.7347 21.5889 23.4804 21.4835 23.2929 21.296C23.1053 21.1084 23 20.8541 23 20.5889V11.0022L8.70662 25.2955C8.51706 25.4722 8.26633 25.5683 8.00726 25.5638C7.74819 25.5592 7.50101 25.4542 7.3178 25.271C7.13458 25.0878 7.02963 24.8406 7.02506 24.5816C7.02049 24.3225 7.11665 24.0718 7.29329 23.8822L21.5866 9.58887H12Z" fill="#121212"/>
                      </svg>
