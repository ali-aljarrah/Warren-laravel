@include('include.head')
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer " style="background-image: url(/assets/imgs/tooth-extractions/banner.webp)">
      <div class="block-padding">
            <div class="container-fluid">
               <div class="row">
               <div class="col-lg-8 mx-auto text-center">
                  <div class="mx-auto">
                      <a href="{{route('oral-surgery')}}" class="text-decoration-none bg-green-card rounded-3 p-2 d-flex justify-content-center align-items-center w-fit mx-auto">
                          <span class="me-2">
                    ...
                    <div class="col-lg-10 align-self-center">
                        ...
                        <p class="black-color fs-16">
                          ...
                          <div class="bg-child-blue p-4 rounded-4 mt-4 mb-4">
                              ...
                              <ul>
                                <li  class="soft-dark fs-16">Severe tooth decay</li>
                                <li  class="soft-dark fs-16">Damaged, broken or infected teeth</li>
                                <li  class="soft-dark fs-16">Teeth that do not come in correctly (or at all)</li>
                                <li  class="soft-dark fs-16">Gum disease</li>
                                <li  class="soft-dark fs-16">Making room for teeth to shift during orthodontic treatment</li>
                                <li  class="soft-dark fs-16">Side effects from certain medications or treatments</li>
                              </ul>
                          </div>
