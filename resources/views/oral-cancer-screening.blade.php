@include('include.head')
    ...
    <link rel="canonical" href="{{env('APP_URL')}}oral-cancer-screening">
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer " style="background-image: url(/assets/imgs/oral-cancer-screening/banner.webp);">
