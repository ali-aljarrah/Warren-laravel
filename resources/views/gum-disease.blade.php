@include('include.head')
    ...
    <link rel="canonical" href="{{env('APP_URL')}}dental-services/periodontics/gum-disease">
  ...
  <body>
    ...
    <section class="page-bg-image lazybg shadow-bg-layer" style="background-image: url(/assets/imgs/gum-disease/banner.webp)">
      <div class="block-padding">
            <div class="container-fluid">
               <div class="row">
               <div class="col-lg-8 mx-auto text-center">
                  <div class="mx-auto">
                      <a href="{{route('periodontics')}}" class="text-decoration-none bg-green-card rounded-3 p-2 d-flex justify-content-center align-items-center w-fit mx-auto">
                          <span class="me-2">
