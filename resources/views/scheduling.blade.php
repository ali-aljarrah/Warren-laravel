  ...
  <body>
    ...
    <section class="py-5">
        <div class="container-fluid">
          <div class="row bg-child-blue p-5 d-flex justify-content-center">
            ...
            <div class="col-lg-5">
               <h1 class="fs-38 mb-4 fw-600 soft-dark">
          ...
          <div class="row bg-white p-5 d-flex justify-content-center">
          <div class="col-lg-6">
               <img width="180" height="180" class="img-fluid" loading="lazy" src="/assets/imgs/patient-information" alt="Warren - atient Information - Warren, MI">
            </div>
          </div>
        </div>
    </section>
